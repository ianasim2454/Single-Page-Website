    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="nav06">
        <ul class="navbar-nav mt-3 mt-lg-0 mb-3 mb-lg-0 ms-lg-3">
          <li class="nav-item me-4"><a class="nav-link" href="#hero">About</a></li>
          <li class="nav-item me-4"><a class="nav-link" href="#work">Services</a></li>
          <li class="nav-item me-4"><a class="nav-link" href="#price">Price</a></li>
          <li class="nav-item me-4"><a class="nav-link" href="#team">Team</a></li>
          <li class="nav-item"><a class="nav-link" href="#news">News Letter</a></li>
        </ul>
      </div>
