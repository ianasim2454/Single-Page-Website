    ...
    <div class="container">
      <div class="row">
        <div class="col-12 col-lg-8 mx-auto text-center mb-5">
          ...
          <h3 class="text-muted text-primary">Team Members</h3>
      ...
      <div class="row">
        <div class="col-12 col-md-6 col-lg-4 mb-4">
          <div class="d-flex justify-content-center align-items-center py-5 bg-light rounded">
            <div class="text-center">
              <img class="mx-auto mb-5 img-fluid rounded-circle" src="{{asset('bootstrap5-plain-assets/images/me.jpg')}}" alt="" style="width: 100px;height: 100px">
              <h4 class="fw-bold">Izaz Ahmmed Nasim</h4>
        ...
        <div class="col-12 col-md-6 col-lg-4 mb-4">
          <div class="d-flex justify-content-center align-items-center py-5 bg-light rounded">
            <div class="text-center">
                <img class="mx-auto mb-5 img-fluid rounded-circle" src="{{asset('bootstrap5-plain-assets/images/img-1.jpg')}}" alt="" style="width: 100px;height: 100px">
                <h4 class="fw-bold">Mr.Akkas</h4>
        ...
        <div class="col-12 col-md-6 col-lg-4 mb-4">
          <div class="d-flex justify-content-center align-items-center py-5 bg-light rounded">
            <div class="text-center">
                <img class="mx-auto mb-5 img-fluid rounded-circle" src="{{asset('bootstrap5-plain-assets/images/img-2.jpg')}}" alt="" style="width: 100px;height: 100px">
                <h4 class="fw-bold">Mr.Bakkas</h4>
                <p class="text-muted">Head Of Department, Software</p>
            </div>
          </div>
        </div>
        <div class="col-12 col-md-6 col-lg-4 mb-4 mb-lg-0">
          <div class="d-flex justify-content-center align-items-center py-5 bg-light rounded">
            <div class="text-center">
                <img class="mx-auto mb-5 img-fluid rounded-circle" src="{{asset('bootstrap5-plain-assets/images/img-3.jpg')}}" alt="" style="width: 100px;height: 100px">
                <h4 class="fw-bold">Mr.Jakkas</h4>
        ...
        <div class="col-12 col-md-6 col-lg-4 mb-4 mb-md-0">
          <div class="d-flex justify-content-center align-items-center py-5 bg-light rounded">
            <div class="text-center">
                <img class="mx-auto mb-5 img-fluid rounded-circle" src="{{asset('bootstrap5-plain-assets/images/img-6.jpg')}}" alt="" style="width: 100px;height: 100px">
                <h4 class="fw-bold">Mrs.Jorina</h4>
        ...
        <div class="col-12 col-md-6 col-lg-4">
          <div class="d-flex justify-content-center align-items-center py-5 bg-light rounded">
            <div class="text-center">
                <img class="mx-auto mb-5 img-fluid rounded-circle" src="{{asset('bootstrap5-plain-assets/images/img-5.jpeg')}}" alt="" style="width: 100px;height: 100px">
                <h4 class="fw-bold">Mrs.Dilara</h4>
